    ...
    return (
        <div className=' pb-10'>
            <div className='py-10 px-16'>
                <h1 className='text-3xl font-bold flex items-center gap-10'>My Education<span className='flex-1 h-0 border-2 border-dashed border-green-400'></span></h1>
            </div>
            <div className='flex justify-center gap-10' data-aos="zoom-in-up">
                <div className='border border-green-400 rounded-md shadow-2xl w-4/12 py-8 pl-4 space-y-4'>
            ...
            <div className='flex justify-center gap-10 mt-10' data-aos="zoom-in-up">
                <div className='border border-green-400 rounded-md shadow-2xl w-4/12 py-8 pl-4 space-y-4'>
