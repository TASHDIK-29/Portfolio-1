                ...
                <div className="lg:flex">
                    <div className="w-full -mx-6 lg:w-2/5">
                        <div className="px-6">
                            ...
                            <p className="max-w-sm mt-2 text-gray-400">Junior MERN stack developer skilled in MongoDB, Express.js, React, and Node.js, passionate about creating dynamic web applications.</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 lg:mt-0 lg:flex-1">
                        <div className="grid gap-6 grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
                            <div>
                                <h3 className="uppercase text-white">Technology</h3>
                                <a href="#" className="block mt-2 text-sm text-gray-400 hover:underline">React.js</a>
                                <a href="#" className="block mt-2 text-sm text-gray-400 hover:underline">Node.js</a>
                                <a href="#" className="block mt-2 text-sm text-gray-400 hover:underline">JavaScript</a>
                                <a href="#" className="block mt-2 text-sm text-gray-400 hover:underline">Tailwind CSS</a>
                            </div>
