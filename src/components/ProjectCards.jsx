...
const ProjectCards = () => {
    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-4 md:p-16'>
            <div className=" rounded-md shadow-md bg-gray-50 text-gray-800"  data-aos="zoom-in-up">
                ...
                <div className="flex flex-col justify-between p-6 space-y-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-800 font-semibold ">Parcel Management System</p>
            ...
            <div className=" rounded-md shadow-md bg-gray-50 text-gray-800"  data-aos="zoom-in-up">
                {/* <img src="/images/workWave.png" alt="img" className="object-cover object-center w-full rounded-t-md h-72 bg-gray-500" /> */}
                ...
                <div className="flex flex-col justify-between p-6 space-y-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-800 font-semibold">Volunteer Management System</p>
                        <h3 className='flex flex-col md:flex-row'><span className='w-2/3 font-semibold'>Key Technologies :</span> <span className='font-bold'>React.js, Node.js, Express.js, MongoDB</span></h3>
                        <div className='flex justify-between'>
            ...
            <div className=" rounded-md shadow-md bg-gray-50 text-gray-800"  data-aos="zoom-in-up">
                {/* <img src="/images/trekTrove.png" alt="img" className="object-cover object-center w-full rounded-t-md h-72 bg-gray-500" /> */}
                ...
                <div className="flex flex-col justify-between p-6 space-y-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-800 font-semibold">Tourism Management System</p>
                        <h3 className='flex flex-col md:flex-row'><span className='w-2/3 font-semibold'>Key Technologies :</span> <span className='font-bold'>React.js, Node.js, Express.js, MongoDB</span></h3>
                        <div className='flex justify-between'>
            ...
            <div className=" rounded-md shadow-md bg-gray-50 text-gray-800"  data-aos="zoom-in-up">
                {/* <img src="/images/khan.png" alt="img" className="object-cover object-center w-full rounded-t-md h-72 bg-gray-500" /> */}
                ...
                <div className="flex flex-col justify-between p-6 space-y-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-800 font-semibold">Real Estate Website</p>
            ...
            <div className=" rounded-md shadow-md bg-gray-50 text-gray-800"  data-aos="zoom-in-up">
                {/* <img src="/images/book.png" alt="img" className="object-cover object-center w-full rounded-t-md h-72 bg-gray-500" /> */}
                ...
                <div className="flex flex-col justify-between p-6 space-y-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-800 font-semibold">Online Library System</p>
            ...
            <div className=" rounded-md shadow-md bg-gray-50 text-gray-800"  data-aos="zoom-in-up">
                {/* <img src="/images/cook.png" alt="img" className="object-cover object-center w-full rounded-t-md h-72 bg-gray-500" /> */}
                ...
                <div className="flex flex-col justify-between p-6 space-y-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-800 font-semibold">Online Cooking Platform</p>
                        <h3 className='flex flex-col md:flex-row'><span className='w-2/3 font-semibold'>Key Technologies :</span> <span className='font-bold'>React.js, JavaScript, Tailwind CSS</span></h3>
                        <div className='flex justify-between'>
            ...
            <div className=" rounded-md shadow-md bg-gray-50 text-gray-800"  data-aos="zoom-in-up">
                {/* <img src="/images/metlib.png" alt="img" className="object-cover object-center w-full rounded-t-md h-72 bg-gray-500" /> */}
                ...
                <div className="flex flex-col justify-between p-6 space-y-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-800 font-semibold">Online Blogging Platform</p>
